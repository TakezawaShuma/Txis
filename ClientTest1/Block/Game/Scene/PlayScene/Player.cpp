...
Player::Player(SOCKET _soc,Vector2 _pos, int _HP, Data::Scenes::SCENETYPE _scene) :
	GameObject(_pos), m_soc(_soc), m_hitPoint(_HP), m_nowScene(_scene), m_nextScene(Data::Scenes::SCENETYPE::NON), m_changeSceneFlag(false)
{
