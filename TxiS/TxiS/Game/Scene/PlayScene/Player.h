...
public:
	Player();
	Player(SOCKET _soc, DirectX::SimpleMath::Vector2 _pos, int _hp, Data::Scenes::SCENETYPE _scene);
	~Player();
...
private:		// 変数
	...
	u_int m_hitPoint;								// HP
	Data::Scenes::SCENETYPE m_nowScene;				// 現在のシーン
	Data::Scenes::SCENETYPE m_nextScene;			// 次のシーン
