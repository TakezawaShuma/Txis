...
namespace Data
{
	...
	namespace Pakets
	{
		...
		struct LobbyData :IPaketData
		{
			...
			LobbyData() { scene.nowScene = Scenes::SCENETYPE::LOBBY; scene.nextScene = Scenes::SCENETYPE::NON; paketId = PaketID::LOBBY_PAKET; }
			LobbyData(SOCKET _soc) { scene.nowScene = Scenes::SCENETYPE::LOBBY; scene.nextScene = Scenes::SCENETYPE::NON; paketId = PaketID::LOBBY_PAKET; socket = _soc; }
			LobbyData(IPaketData _i) { scene.nowScene = _i.scene.nowScene; scene.nextScene = _i.scene.nextScene; paketId = _i.paketId; socket = _i.socket; }
